...
export const translations: Translations = {
  ...
  service_supply_desc: {
    ...
    ar: 'نحافظ على سلسلة توريد موثوقة لضمان وصول المنتجات الأساسية للعيادات البيطرية والمستشفيات بشكل مستمر.',
  },
  ...
  footer_copyright: {
    en: '© 2026 AL-Rakiza AL-jadida. All rights reserved.',
    ar: '© ٢٠٢٦ الركيزة الجديدة. جميع الحقوق محفوظة.',
  },
